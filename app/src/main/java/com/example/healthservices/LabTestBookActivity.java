...
public class LabTestBookActivity extends AppCompatActivity {
    ...
    public void volleyRequest() {
        ...
        String url = "http://10.0.2.2/HealthServiceAdmin/laborder/setdata.php";
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, url, jsonParams,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        Toast.makeText(LabTestBookActivity.this, "Success", Toast.LENGTH_SHORT).show();
                    }
                },
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(LabTestBookActivity.this, "Error", Toast.LENGTH_SHORT).show();
                    }
                });
